...
public class QueryUtils {
    ...
    private QueryUtils() {
      /*  ArrayList<Earthquake> quakes = new ArrayList<>();
        String url;
        int i=0;
        while( SAMPLE_JSON_RESPONSE!= null )
        {
            if (SAMPLE_JSON_RESPONSE.contains("http"));
            url=SAMPLE_JSON_RESPONSE;
            continue;
    ...
    public  static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0;i<featuresArray.length();i++) {
                ...
                Earthquake e =new Earthquake(properties.getString("mag"),properties.getString("place"),properties.getString("time"));
                earthquakes.add(e);
